...
function verseWordTests() {
  ...
  it('linking a verse to a word', async () => {
    let newVerseWord = {
      ...
      word_explanation: 'The word_explanation for the word in this verse goes here.',
      visible: false,
    };
  ...
  it('updating a verseWord', async () => {
    let newVerseWord = {
      ...
      word_id: seedData.ArabicWord[0].word_id,
      verse_id: seedData.Verse[0].verse_index,
      word_explanation: 'The updated word_explanation for the word in this verse goes here.',
      visible: true,
    };
...
function checkMatch(verseWordA: any, verseWordB: any) {
